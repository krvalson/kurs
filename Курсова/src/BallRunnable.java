...
class BallRunnable implements Runnable
{
    ...
    class MousePlayer extends MouseAdapter//Возникновение шарика-ловушки при клике на игровом пространстве
    {
        public void mousePressed(MouseEvent e)
        {
            ...
            ballComponent.removeMouseListener((MouseListener) mousePlayerListener);
            ballComponent.removeMouseMotionListener((MouseMotionListener) mousePlayerListener);
    ...
    public void run()
    {
        while(true)
        {
            try
            {
                ...
                ballComponent.addMouseListener((MouseListener) mousePlayerListener);
                ballComponent.addMouseMotionListener((MouseMotionListener) mousePlayerListener);
                ...
                while (countInWork!=0)
                {
                    ...
                    {
                        if((ball.inAction == 1 || ball.inAction==2))
                            countInWork++; //если остались активированные шарики
